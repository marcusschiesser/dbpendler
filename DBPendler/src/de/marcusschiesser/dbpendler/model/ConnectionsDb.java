package de.marcusschiesser.dbpendler.model;
...
public class ConnectionsDb extends SQLiteOpenHelper {
	...
	public long createConnection(ConnectionVO connection) {
		...
		initialValues.put(KEY_START, connection.start);
		initialValues.put(KEY_DESTINATION, connection.destination);
		initialValues.put(KEY_STARTTIME, connection.startTime.getTime());
		initialValues.put(KEY_ENDTIME, connection.destinationTime.getTime());
	...
	public boolean updateConnection(long rowId, ConnectionVO connection) {
		...
		args.put(KEY_START, connection.start);
		args.put(KEY_DESTINATION, connection.destination);
		args.put(KEY_STARTTIME, connection.startTime.getTime());
		args.put(KEY_ENDTIME, connection.destinationTime.getTime());
	...
	public static ConnectionVO createConnectionFromCursor(Cursor cursor) {
		...
		ConnectionVO connectionVO = new ConnectionVO(cursor.getString(cursor.getColumnIndex(KEY_START)),
				cursor.getString(cursor.getColumnIndex(KEY_DESTINATION)),
